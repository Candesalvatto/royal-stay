...
const Home = () => {
  return (
    <div>
      <div className="border border-black max-w-9/10 md:max-w-8/10 mx-auto  flex flex-col md:flex-row items-start md:items-end md:justify-between mt-20 mb-7  md:mt-50 md:mb-15">
        <h1 className={`${oswald.className} antialiased ${style.royalcolor}  text-[44px] md:text-[64px] lg:text-[85px]  md:w-3/4 font-bold leading-[1.1]`}>VIVE CADA LUGAR Y SÉ PARTE DE SU HISTORIA</h1>
      ...
      <h2 className={`${oswald.className} antialiased ${style.royalcolor} text-[36px] md:text-[58px]  font-bold mt-5 md:w-2/3 leading-[1.1]`}>BUENOS AIRES MAS ALLÁ DE LO TURÍSTICO</h2>
...
>
    VER MÁS
      ...
      <section className='border-2 border-[#000000] mt-15 md:mt-10 max-w-9/10 md:max-w-8/10 mx-auto grid md:grid-cols-2 md:gap-15 gap-10'>

        <Link href="/experiences" className='border border-[#45869] '>
          <div >
            <Image
                    src='/masajes.jpeg'
        ...
        <Link href="/experiences" className='border border-[#000000]'>
          <div>
            <Image
                    src='/vinos.jpg'
                    alt='Masajes Relajantes'
      ...
      <section className='border-t border-[#c8a951] max-w-9/10 md:max-w-8/10 mx-auto mt-10 md:mt-30 md:mb-10'>
      <h2 className={`${oswald.className} antialiased ${style.royalcolor} text-[36px] md:text-[58px]  font-bold mt-5 md:w-2/3 leading-[1.1]`}>CÓMO FUNCIONA</h2>
      ...
      <section className='border border-[#000000] max-w-9/10 md:max-w-8/10 mx-auto md:mt-10 md:mb-10 grid md:grid-cols-3 md:gap-4 gap-1'>
        <div className='border border-[#000000] md:mt-5 md:mb-5 mt-5 mb-2'>
        <div className='flex flex-row'>
          <p className={`${oswald.className} antialiased ${style.royalcolor}  mr-4 text-16px md:text-[20px] font-light border border-[#c8a951] md:px-3 px-2 py-1 `}>01</p>
        ...
        <div className='border border-[#000000] md:mt-5 md:mb-5 mt-3 mb-2 '>
        <div className='flex flex-row'>
          <p className={`${oswald.className} antialiased ${style.royalcolor} mr-4 text-16px md:text-[20px] font-light border border-[#c8a951] md:px-3 px-2 py-1  `}>02</p>
        ...
        <div className='border border-[#000000] md:mt-5 md:mb-5 mt-3 mb-2'>
        <div className='flex flex-row'>
          <p className={`${oswald.className} antialiased ${style.royalcolor} mr-4 text-16px md:text-[20px] font-light border border-[#c8a951] md:px-3 px-2 py-1 `}>03</p>
      ...
      <section className='border border-[#000000] gap-5 max-w-9/10 md:max-w-8/10 mx-auto mt-10 mb-10 flex flex-col md:flex-row md:justify-center md:items-center'>
      <div className='grid md:w-2/4 gap-5 border-3 border-amber-950 md:grid-flow-col md:grid-rows-3 md:gap-1 '>
      <Image
                    src='/cancha-2.jpg'
                    alt='Masajes Relajantes'
                    width={300}
                    height={430}
                    className='col-span-2  hidden md:block object-cover'/>
        ...
        <Image
                    ...
                    width={300}
                    height={430}
                    className='col-span-2 row-span-2 hidden md:block object-cover'/>
        <Image
                    src='/bandera.jpg'
                    alt='Masajes Relajantes'
                    width={300}
                    height={300}
                    className='row-span-3 hidden md:block object-cover  '/>
...
<Image
      ...
      <div className='border border-[#c8a951] md:px-15 mx-auto md:w-2/4 h-90 p-5 flex flex-col justify-center  '>
          <h2 className={`${oswald.className} antialiased ${style.royalcolor} text-[36px] md:text-[58px]  font-bold  leading-[1.1]`}>CREANDO MOMENTOS DE CONEXIÓN REALES</h2>
    ...
    Pensamos en quienes buscan autenticidad y calidad.</p>
              <div className={`${inter.className}  md:mt-10 mt-7`}>
                  <Button
                  href="/aboutus"
                  >
                      VER MÁS

...
const Home = () => {
  ...
  <AOSProvider>
    <div className="bg-white mt-35" >
      ...
      <div className="max-w-9/10 lg:max-w-8/10 mx-auto  sm:max-w-9/10  flex flex-col lg:flex-row items-start lg:items-end lg:justify-between  mb-7  lg:mt-50 lg:mb-15">
        <h1 data-aos="fade-right" className={`${oswald.className} antialiased ${style.royalcolor}  text-[54px]  lg:text-[85px]  md:w-3/4 font-bold leading-[1.1]`}>VIVE CADA LUGAR Y SÉ PARTE DE SU HISTORIA</h1>
        <p  data-aos="fade-left"  className={`${inter.className} antialiased ${style.textcolor}  text-[16px] lg:w-1/4 mt-5`}>Experiencias auténticas pensadas para descubrir la esencia de Buenos Aires</p>
      </div>
      <div>
        <Image
        data-aos="fade-up"
      ...
      <div         data-aos="fade-up"
        data-aos-anchor-placement="top-bottom" className=' border-t border-[#c8a951] mt-15 lg:mt-30 lg:mb-20 max-w-9/10 lg:max-w-8/10 mx-auto flex flex-col lg:flex-row lg:justify-between lg:items-end'>
      <h2 className={`${oswald.className} antialiased ${style.royalcolor} text-[36px] lg:text-[58px]  font-bold mt-5 lg:mt-10 lg:w-2/3 leading-[1.3]`}>BUENOS AIRES MAS ALLÁ DE LO TURÍSTICO</h2>
...
>
    VER MÁS
      ...
      <section        data-aos="fade-up"
        data-aos-anchor-placement="top-bottom" className=' mt-15  max-w-9/10 lg:max-w-8/10 mx-auto grid md:grid-cols-2 md:gap-15 gap-10'>
      ...
      <section         data-aos="fade-up"
        data-aos-anchor-placement="top-bottom" className='border-t border-[#c8a951] max-w-9/10 lg:max-w-8/10 mx-auto mt-20 lg:mt-30 lg:mb-10'>
      <h2 className={`${oswald.className} antialiased ${style.royalcolor} text-[36px] lg:text-[58px]  font-bold mt-5 lg:w-2/3 lg:mt-10  leading-[1.3]`}>CÓMO FUNCIONA</h2>
      ...
      <section          data-aos="fade-up"
        data-aos-anchor-placement="top-bottom" className='  gap-5  max-w-9/10 lg:max-w-8/10 mx-auto mt-10 mb-10 flex flex-col-reverse lg:flex-row lg:justify-center lg:items-center'>
...
<Image
      ...
      <div className='border border-[#c8a951] lg:px-15 mx-auto lg:w-1/2  py-15 px-5 flex flex-col justify-center  z-10'>
          <h2 className={`${oswald.className} antialiased ${style.royalcolor} text-[36px] lg:text-[58px]  font-bold  leading-[1.3]`}>CREANDO MOMENTOS DE CONEXIÓN REALES</h2>
